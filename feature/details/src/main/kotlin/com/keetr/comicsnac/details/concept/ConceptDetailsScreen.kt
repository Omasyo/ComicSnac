...
@Composable
internal fun ConceptDetailsScreen(
    modifier: Modifier = Modifier,
    onItemClicked: (fullId: String) -> Unit,
    onBackPressed: () -> Unit,
    detailsUiState: DetailsUiState<ConceptDetails>,
    ...
    when (detailsUiState) {
        ...
        is Success -> {
            ...
            with(detailsUiState.content) {
                ...
                val webViewContent = rememberComicWebViewContent(description, Domain, onItemClicked)
